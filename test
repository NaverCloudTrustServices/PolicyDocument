# 1 **NAVER Cloud Trust Services**
# 2 **Certificate Policy / Certificate Practices Statement**
...
### 2.2.1 [1. INTRODUCTION](#1-introduction)
...
### 2.2.2 [2. PUBLICATION AND REPOSITORY RESPONSIBILITIES](#2-publication-and-repository-responsibilities)
...
### 2.2.3 [3. IDENTIFICATION AND AUTHENTICATION](#3-identification-and-authentication)
...
### 2.2.4 [4. CERTIFICATE LIFE-CYCLE OPERATIONAL REQUIREMENTS](#4-certificate-life-cycle-operational-requirements)
...
### 2.2.5 [5. FACILITY, MANAGEMENT, AND OPERATIONAL CONTROLS](#5-facility-management-and-operational-controls)
- [5.1 Physical Security Controls](#51-physical-security-controls)

### 2.2.6 [6. TECHNICAL SECURITY CONTROLS](#6-technical-security-controls)
- [6.1 Key Pair Generation and Installation](#61-key-pair-generation-and-installation)

### 2.2.7 [7. CERTIFICATE, CRL, AND OCSP PROFILES](#7-certificate-crl-and-ocsp-profiles)
- [7.1 Certificate Profile](#71-certificate-profile)

### 2.2.8 [8. COMPLIANCE AUDIT AND OTHER ASSESSMENTS](#8-compliance-audit-and-other-assessments)
- [8.1 Frequency and Circumstances of Assessment](#81-frequency-and-circumstances-of-assessment)

### 2.2.9 [9. OTHER BUSINESS AND LEGAL MATTERS](#9-other-business-and-legal-matters)
- [9.1 Fees](#91-fees)
...
## 3.2 1.2 Document Name and Identification
...
### 3.3.1 1.3.1 Certification Authorities
...
### 3.3.2 1.3.2 Registration Authorities
...
### 3.3.5 1.3.5 Other Participants

No Stipulation

## 3.4 1.4 Certificate Usage

### 3.4.1 1.4.1 Appropriate Certificate Uses
...
### 3.4.2 1.4.2 Prohibited Certificate Uses
...
## 3.5 1.5 Policy Administration

### 3.5.1 1.5.1 Organization Administering the Document

NAVER Cloud Trust Services establishes and amends CP/CPS.

### 3.5.2 1.5.2 Contact Person
...
### 3.5.3 1.5.3 Person Determining CPS Suitability for the Policy
...
### 3.5.4 1.5.4 CP/CPS Approval Procedures
...
## 3.6 1.6 Definitions and Acronyms {#definitions-and-acronyms-1}

### 3.6.1 1.6.1 Definitions
...
# 4 2. PUBLICAION AND REPOSITORY RESPONSIBILITIES

## 4.1 2.1 Repositories
...
## 4.2 2.2 Publication of Certification Information
...
## 4.3 2.3 Time or Frequency of Publication
...
## 4.4 2.4 Access Controls on Repositories
...
### 5.1.6 3.1.6 Recognition, Authentication, and Role of Trademarks
...
## 5.2 3.2 Initial Identity Validation

### 5.2.1 3.2.1 Method to Prove Possession of Private Key
...
### 5.2.2 3.2.2 Authentication of Organization and Domain Identity
...
### 5.2.5 3.2.2.3 Verification of Country

See Section 3.2.2.1

### 5.2.6 3.2.2.4 Validation of Domain Authorization or Control
...
### 5.2.7 3.2.2.5 Authentication of an IP Address {#authentication-of-an-ip-address-1}

NAVER Cloud Trust Services does not issue a Certificate using IP
Address.

### 5.2.8 3.2.2.6 Wildcard Domain Validation
...
### 5.2.9 3.2.2.7 Data Source Accuracy and Validity Periods
...
### 5.2.13 3.2.5 Validation of Authority
...
### 5.2.14 3.2.6 Criteria for Interoperation
...
## 5.3 3.3 Identification and Authentication for Re-Key Requests
...
### 5.3.1 3.3.1 Identification and Authentication for Routine Re-Key

See Section 3.2.2

### 5.3.2 3.3.2 Identification and Authentication for Re-Key After Revocation

See Section 3.2.2

## 5.4 3.4 Identification and Authentication for Revocation Request
...
# 6 4. CERTIFICATE LIFE-CYCLE OPERATIONAL REQUIREMENTS

## 6.1 4.1 Certificate Application

### 6.1.1 4.1.1 Who Can Submit a Certificate Application
...
### 6.1.2 4.1.2 Enrollment Process and Responsibilities
...
## 6.2 4.2 Certificate Application Processing
...
### 6.2.1 4.2.1 Performing Identification and Authentication Functions
...
### 6.2.2 4.2.2 Approval or Rejection of Certificate Applications
...
### 6.2.3 4.2.3 Time to Process Certificate Applications
...
### 6.2.4 4.2.4 Certificate Authority Authorization (CAA) Records
...
## 6.3 4.3 Certificate Issuance

### 6.3.1 4.3.1 CA Actions During Certificate Issuance
...
### 6.3.2 4.3.2 Notifications to Subscriber by the CA of Issuance of Certificate

NAVER Cloud Trust Services notifies Subscriber of the issuance of a
Certificate either via email.

## 6.4 4.4 Certificate Acceptance

### 6.4.1 4.4.1 Conduct Constituting Certificate Acceptance
...
### 6.4.2 4.4.2 Publication of the Certificate by the CA
...
### 6.4.3 4.4.3 Notification of Certificate Issuance by the CA to Other Entities
...
## 6.5 4.5 Key Pair and Certificate Usage

### 6.5.1 4.5.1 Subscriber Private Key and Certificate Usage
...
### 6.5.2 4.5.2 Relying Party Public Key and Certificate Usage

No stipulation

## 6.6 4.6 Certificate Renewal

### 6.6.1 4.6.1 Circumstances for Certificate Renewal
...
### 6.6.2 4.6.2 Who May Request Renewal

No stipulation

### 6.6.3 4.6.3 Processing Certificate Renewal Requests

No stipulation

### 6.6.4 

### 6.6.5 4.6.4 Notification of New Certificate Issuance to Subscriber

No stipulation

### 6.6.6 4.6.5 Conduct Constituting Acceptance of a Renewal Certificate

No stipulation

### 6.6.7 4.6.6 Publication of the Renewal Certificate by the CA

No stipulation

### 6.6.8 4.6.7 Notification of Certificate Issuance by the CA to Other Entities

No stipulation

## 6.7 4.7 Certificate Re-Key

### 6.7.1 4.7.1 Circumstances for Certificate Re-Key

NAVER Cloud Trust Services treats certificate re-key requests as
requests for the issuance of a new Certificate.

### 6.7.2 4.7.2 Who May Request Certification of a New Public Key

No stipulation

### 6.7.3 4.7.3 Processing Certificate Re-Keying Requests

No stipulation

### 6.7.4 4.7.4 Notification of New Certificate Issuance to Subscriber

No stipulation

### 6.7.5 4.7.5 Conduct Constituting Acceptance of a Re-Keyed Certificate

No stipulation

### 6.7.6 4.7.6 Publication of the Re-Keyed Certificate by the CA

No stipulation

### 6.7.7 4.7.7 Notification of Certificate Issuance by the CA to Other Entities

No stipulation

## 6.8 4.8 Certificate Modification

### 6.8.1 4.8.1 Circumstances for Certificate Modification
...
### 6.8.2 4.8.2 Who May Request Certificate Modification

No stipulation

### 6.8.3 4.8.3 Processing Certificate Modification Requests

No stipulation

### 6.8.4 4.8.4 Notification of New Certificate Issuance to Subscriber

No stipulation

### 6.8.5 4.8.5 Conduct Constituting Acceptance of Modified Certificate

No stipulation

### 6.8.6 4.8.6 Publication of the Modified Certificate by the CA

No stipulation

### 6.8.7 4.8.7 Notification of Certificate Issuance by the CA to Other Entities

No stipulation

## 6.9 4.9 Certificate Revocation and Suspension {#certificate-revocation-and-suspension-1}
...
### 6.9.1 4.9.1 Circumstances for Revocation

### 6.9.2 4.9.1.1 Reasons for Revoking a Subscriber Certificate
...
### 6.9.3 4.9.1.2 Reasons for Revoking a Subordinate CA Certificate
...
### 6.9.4 4.9.2 Who Can Request Revocation
...
### 6.9.5 4.9.3 Procedure for Revocation Request
...
### 6.9.6 4.9.4 Revocation Request Grace Period
...
### 6.9.7 4.9.5 Time Within Which CA Must Process the Revocation Request
...
### 6.9.8 4.9.6 Revocation Checking Requirements for Relying Parties
...
### 6.9.9 4.9.7 CRL Issuance Frequency
...
### 6.9.10 4.9.8 Maximum Latency for CRLs {#maximum-latency-for-crls-1}

The CRL is posted to the CRL repository within an hour following the CRL
generation.

### 6.9.11 4.9.9 On-Line Revocation/Status Checking Availability
...
### 6.9.12 4.9.10 On-Line Revocation Checking Requirements {#on-line-revocation-checking-requirements-1}
...
### 6.9.13 4.9.11 Other Forms of Revocation Advertisements Available

No Stipulation

### 6.9.14 4.9.12 Special Requirements re Key Compromise
...
### 6.9.15 4.9.13 Circumstances for Suspension

No Stipulation

### 6.9.16 4.9.14 Who Can Request Suspension

No Stipulation

### 6.9.17 4.9.15 Procedure for Suspension Request

No Stipulation

### 6.9.18 4.9.16 Limits on Suspension Period

No Stipulation

## 6.10 4.10 Certificate Status Services

### 6.10.1 4.10.1 Operational Characteristics

Revocation entries on a CRL or OCSP Response MUST NOT be removed until
after the Expiry Date of the revoked Certificate

### 6.10.2 4.10.2 Service Availability
...
### 6.10.3 4.10.3 Optional Features

No stipulation

## 6.11 4.11 End of Subscription
...
## 6.12 4.12 Key Escrow and Recovery

NAVER Cloud Trust Services does not escrow the subscribers' private
keys.

### 6.12.1 4.12.1 Key Escrow and Recovery Policy and Practices

No Stipulation

### 6.12.2 4.12.2 Session key encapsulation and recovery policy and practices

No Stipulation

# 7 5. FACILITY, MANAGEMENT, AND OPERATIONAL CONTROLS

## 7.1 5.1 Physical Security Controls
...
### 7.1.1 5.1.1 Site Location and Construction
...
### 7.1.3 5.1.3 Power and Air Conditioning
...
## 7.2 5.2 Procedural Controls

### 7.2.1 5.2.1 Trusted Roles
...
### 7.2.2 5.2.2 Number of Individuals Required per Task
...
### 7.2.3 5.2.3 Identification and Authentication for Each Role
...
### 7.2.4 5.2.4 Roles Requiring Separation of Duties
...
## 7.3 5.3 Personnel Controls

### 7.3.1 5.3.1 Qualifications, Experience, and Clearance Requirements
...
### 7.3.2 5.3.2 Background Check Procedures
...
### 7.3.3 5.3.3 Training Requirements and Procedures
...
### 7.3.4 5.3.4 Retraining Frequency and Requirements
...
### 7.3.5 5.3.5 Job Rotation Frequency and Sequence

No stipulation

### 7.3.6 5.3.6 Sanctions for Unauthorized Actions
...
### 7.3.7 5.3.7 Independent Contractor Requirements
...
### 7.3.8 5.3.8 Documentation Supplied to Personnel
...
## 7.4 5.4 Audit Logging Procedures

### 7.4.1 5.4.1 Types of Events Recorded
...
#### 7.4.1.1 5.4.1.1 Router and firewall activities logs
...
### 7.4.2 5.4.2 Frequency of Processing Log
...
### 7.4.3 5.4.3 Retention Period for Audit Log
...
### 7.4.4 5.4.4 Protection of Audit Log
...
### 7.4.5 5.4.5 Audit Log Backup Procedures
...
### 7.4.6 5.4.6 Audit Log Accumulation System (internal vs. external)

No stipulation

### 7.4.7 5.4.7 Notification to Event-Causing Subject

No stipulation

### 7.4.8 5.4.8 Vulnerability Assessments
...
## 7.5 5.5 Records Archival

### 7.5.1 5.5.1 Types of Records Archived
...
### 7.5.2 5.5.2 Retention Period for Archive {#retention-period-for-archive-1}
...
### 7.5.3 5.5.3 Protection of Archive
...
### 7.5.4 5.5.4 Archive Backup Procedures
...
### 7.5.5 5.5.5 Requirements for Time-Stamping of Records
...
### 7.5.6 5.5.6 Archive Collection System (Internal or External)

No stipulation

### 7.5.7 5.5.7 Procedures to Obtain and Verify Archive Information

No stipulation

## 7.6 5.6 Key Changeover
...
## 7.7 5.7 Compromise and Disaster Recovery {#compromise-and-disaster-recovery-1}

### 7.7.1 5.7.1 Incident and Compromise Handling Procedures
...
### 7.7.2 5.7.2 Computing Resources, Software, and/or Data Are Corrupted
...
### 7.7.3 5.7.3 Entity Private Key Compromise Procedures
...
### 7.7.4 5.7.4 Business Continuity Capabilities After a Disaster
...
# 8 6. TECHNICAL SECURITY CONTROLS

## 8.1 6.1 Key Pair Generation and Installation

### 8.1.1 6.1.1 Key Pair Generation
...
### 8.1.2 6.1.2 Private Key Delivery to Subscriber

NAVER Cloud Trust Services does not generate subscriber Key Pairs.

### 8.1.3 6.1.3 Public Key Delivery to Certificate Issuer
...
### 8.1.4 6.1.4 CA Public Key Delivery to Relying Parties
...
### 8.1.6 6.1.6 Public Key Parameters Generation and Quality Checking
...
### 8.1.7 6.1.7 Key Usage Purposes (as per X.509 v3 Key Usage Field)
...
## 8.2 6.2 Private Key Protection and Cryptographic Module Engineering Controls

### 8.2.1 6.2.1 Cryptographic Module Standards and Controls

CA key pairs are archived and operated in a hardware security module
with FIPS 140-2 Level 3 or higher.

### 8.2.2 6.2.2 Private Key (n out of m) Multi-Person Control
...
### 8.2.5 6.2.5 Private Key Archival

NAVER Cloud Trust Services does not archive CA private keys.

### 8.2.6 6.2.6 Private Key Transfer Into or From a Cryptographic Module
...
### 8.2.7 6.2.7 Private Key Storage on Cryptographic Module
...
### 8.2.8 6.2.8 Method of Activating Private Key
...
### 8.2.9 6.2.9 Method of Deactivating Private Key
...
### 8.2.10 6.2.10 Method of Destroying Private Key
...
### 8.2.11 6.2.11 Cryptographic Module Rating

Use a hardware security module that conforms to the requirements of
Section 6.2.1.

## 8.3 6.3 Other Aspects of Key Pair Management

### 8.3.1 6.3.1 Public Key Archival

CA, RA, and subscriber certificates are archived in accordance with
NAVER Cloud Trust Services backup procedures.

### 8.3.2 6.3.2 Certificate Operational Periods and Key Pair Usage Periods
...
## 8.4 6.4 Activation Data {#activation-data-1}

### 8.4.1 6.4.1 Activation Data Generation and Installation
...
### 8.4.2 6.4.2 Activation Data Protection {#activation-data-protection-1}
...
### 8.4.3 6.4.3 Other Aspects of Activation Data {#other-aspects-of-activation-data-1}

No stipulation

## 8.5 6.5 Computer Security Controls

### 8.5.1 6.5.1 Specific Computer Security Technical Requirements
...
### 8.5.2 6.5.2 Computer Security Rating

No stipulation

## 8.6 6.6 Life Cycle Technical Controls

### 8.6.1 6.6.1 System Development Controls
...
### 8.6.2 6.6.2 Security Management Controls
...
### 8.6.3 6.6.3 Life Cycle Security Controls

No stipulation

## 8.7 6.7 Network Security Controls
...
# 9 7. CERTIFICATE, CRL, AND OCSP PROFILES

## 9.1 7.1 Certificate Profile
...
## 9.2 7.1.2.1 Root CA Certificate
...
### 9.2.1 7.1.2.1.1 *Root CA Validity*
...
### 9.2.2 7.1.2.1.2 *Root CA Extensions*
...
### 9.2.3 7.1.2.1.3 *Root CA Authority Key Identifier*
...
### 9.2.4 7.1.2.1.4 *Root CA Basic Constraints*
...
## 9.3 7.1.2.2 *Cross-Certified Subordinate CA Certificate Profile*
...
### 9.3.2 7.1.2.2.1 *Cross-Certified Subordinate CA Validity*
...
### 9.3.3 7.1.2.2.2 *Cross-Certified Subordinate CA Naming*
...
### 9.3.4 7.1.2.2.3 *Cross-Certified Subordinate CA Extensions*
...
### 9.3.5 Table: Cross-Certified Subordinate CA with Unrestricted EKU
...
### 9.3.6 Table: Cross-Certified Subordinate CA with Restricted EKU

| **Extension**  | **Presence** | **Critical** | **Description**               |
|--------------|-------------|-------------|-------------------------------|
| extKeyUsage | MUST³       | N           | See Section 7.1.2.2.5         |

### 9.3.7 7.1.2.2.4 Cross-Certified Subordinate CA Extended Key Usage - Unrestricted

#### 9.3.7.1 Table: Unrestricted Extended Key Usage Purposes (Affiliated Cross-Certified CA)
...
### 9.3.8 7.1.2.2.5 Cross-Certified Subordinate CA Extended Key Usage

#### 9.3.8.1 Table: Restricted TLS Cross-Certified Subordinate CA Extended Key Usage Purposes
...
#### 9.3.8.2 Table: Restricted Non-TLS Cross-Certified Subordinate CA Extended Key Usage Purposes
...
# 10 7.1.2.3 Technically Constrained Non-TLS Subordinate CA Certificate Profile
...
# 11 7.1.2.3.2 Technically Constrained Non-TLS Subordinate CA Certificate Policies
...
### 11.0.1 7.1.2.4 Technically Constrained Precertificate Signing CA Certificate Profile
...
# 12 7.1.2.4.2 Technically Constrained Precertificate Signing CA Extended Key Usage
...
### 12.0.1 7.1.2.5 Technically Constrained TLS Subordinate CA Certificate Profile
...
# 13 7.1.2.5.1 Technically Constrained TLS Subordinate CA Extensions
...
# 14 7.1.2.5.2 Technically Constrained TLS Subordinate CA Name Constraints
...
#### 14.0.0.1 Table: nameConstraints requirements
...
#### 14.0.0.2 Table: GeneralName requirements for the base field
...
### 14.0.1 7.1.2.6 TLS Subordinate CA Certificate Profile
...
### 14.0.2 7.1.2.6.1 TLS Subordinate CA Extensions
...
### 14.0.3 7.1.2.7 Subscriber (Server) Certificate Profile
...
### 14.0.4 7.1.2.7.1 Subscriber Certificate Types
...
### 14.0.5 7.1.2.7.2 Domain Validated
...
#### 14.0.5.1 Table: Domain Validated Subject Attributes
...
### 14.0.6 7.1.2.7.3 Individual Validated (IV)
...
#### 14.0.6.1 Table: Individual Validated Subject Attributes
...
### 14.0.7 7.1.2.7.4 Organization Validated
...
#### 14.0.7.1 Table: Organization Validated Subject Attributes
...
### 14.0.8 7.1.2.7.5 Extended Validation
...
### 14.0.9 7.1.2.7.6 Subscriber Certificate Extensions
...
### 14.0.10 7.1.2.7.7 Subscriber Certificate Authority Information Access
...
#### 14.0.10.1 Table: Authority Information Access
...
### 14.0.11 7.1.2.7.8 Subscriber Certificate Basic Constraints
...
### 14.0.12 7.1.2.7.9 Subscriber Certificate Certificate Policies
...
### 14.0.13 Table: Permitted policyQualifiers
...
### 14.0.14 7.1.2.7.10 Subscriber Certificate Extended Key Usage
...
### 14.0.15 7.1.2.7.11 Subscriber Certificate Key Usage

CAs **MUST** ensure the `Key Usage` is appropriate for the Certificate's `Public Key`.

#### 14.0.15.1 Table: Key Usage for RSA Public Keys
...
#### 14.0.15.2 Table: Key Usage for ECC Public Keys
...
### 14.0.16 7.1.2.7.12 Subscriber Certificate Subject Alternative Name
...
#### 14.0.16.1 Table: GeneralName within a subjectAltName extension
...
### 14.0.17 7.1.2.8 OCSP Responder Certificate Profile
...
### 14.0.18 7.1.2.8.1 OCSP Responder Validity
...
### 14.0.19 7.1.2.8.2 OCSP Responder Extensions
...
### 14.0.20 7.1.2.8.3 OCSP Responder Authority Information Access
...
#### 14.0.20.1 Table: Authority Information Access for OCSP Responder
...
### 14.0.21 7.1.2.8.4 OCSP Responder Basic Constraints
...
### 14.0.22 7.1.2.8.5 OCSP Responder Extended Key Usage
...
### 14.0.23 7.1.2.8.6 OCSP Responder id-pkix-ocsp-nocheck
...
### 14.0.24 7.1.2.8.7 OCSP Responder Key Usage
...
### 14.0.25 7.1.2.8.8 OCSP Responder Certificate Policies
...
#### 14.0.25.1 Table: Permitted policyQualifiers
...
### 14.0.26 7.1.2.9 Precertificate Profile
...
#### 14.0.26.1 Table: When the Precertificate is issued directly by the Issuing CA
...
### 14.0.27 Table: When the Precertificate is issued by a Precertificate Signing CA on behalf of an Issuing CA
...
### 14.0.28 7.1.2.9.1 Precertificate Profile Extensions - Directly Issued
...
### 14.0.29 7.1.2.9.2 Precertificate Profile Extensions - Precertificate CA Issued
...
### 14.0.30 7.1.2.9.3 Precertificate Poison
...
### 14.0.31 7.1.2.9.4 Precertificate Authority Key Identifier
...
### 14.0.32 7.1.2.10 Common CA Fields
...
### 14.0.33 7.1.2.10.1 CA Certificate Validity
...
### 14.0.34 7.1.2.10.2 CA Certificate Naming

All `subject` names **MUST** be encoded as specified in **Section 7.1.4**.

#### 14.0.34.1 Table: Acceptable Subject Attributes for CA Certificates
...
### 14.0.35 7.1.2.10.3 CA Certificate Authority Information Access
...
### 14.0.36 7.1.2.10.3 CA Certificate Authority Information Access
...
#### 14.0.36.1 Table: Authority Information Access for CA Certificates
...
### 14.0.37 7.1.2.10.4 CA Certificate Basic Constraints
...
### 14.0.38 7.1.2.10.5 CA Certificate Certificate Policies

If present, the `Certificate Policies` extension **MUST** contain at least one `PolicyInformation`.  
Each `PolicyInformation` **MUST** match the following profile:

#### 14.0.38.1 Table: No Policy Restrictions (Affiliated CA)
...
#### 14.0.38.2 Table: Policy Restricted
...
#### 14.0.38.3 Table: Permitted policyQualifiers
...
### 14.0.39 7.1.2.10.6 CA Certificate Extended Key Usage
...
### 14.0.40 7.1.2.10.7 CA Certificate Key Usage
...
### 14.0.41 7.1.2.10.8 CA Certificate Name Constraints
...
#### 14.0.41.1 Table: nameConstraints requirements
...
#### 14.0.41.2 Table: GeneralName requirements for the base field
...
### 14.0.42 7.1.2.11 Common Certificate Fields
...
### 14.0.43 7.1.2.11.1 Authority Key Identifier
...
### 14.0.44 7.1.2.11.2 CRL Distribution Points
...
#### 14.0.44.1 Table: DistributionPoint profile
...
### 14.0.45 7.1.2.11.3 Signed Certificate Timestamp List
...
### 14.0.46 7.1.2.11.4 Subject Key Identifier
...
### 14.0.47 7.1.2.11.5 Other Extensions
...
### 14.0.48 7.1.3 Algorithm Object Identifiers {#algorithm-object-identifiers-1}

#### 14.0.48.1 7.1.3.1 SubjectPublicKeyInfo
...
#### 14.0.48.2 7.1.3.2 Signature AlgorithmIdentifier
...
### 14.0.49 7.1.4 Name Forms

#### 14.0.49.1 7.1.4.1 Issuer Information
...
#### 14.0.49.2 7.1.4.2 Subject Information -- Subscriber Certificates
...
#### 14.0.49.3 7.1.4.3. Subscriber Certificate Common Name Attribute
...
#### 14.0.49.4 7.1.4.4. Other Subject Attributes
...
### 14.0.50 7.1.5 Name Constraints

No stipulation.

### 14.0.51 7.1.6 Certificate Policy Object Identifier
...
### 14.0.52 7.1.7 Usage of Policy Constraints Extension

No stipulation

### 14.0.53 7.1.8 Policy Qualifiers Syntax and Semantics

No stipulation

### 14.0.54 7.1.9 Processing Semantics for the Critical Certificate Policies Extension

No stipulation

## 14.1 7.2 CRL Profile
...
### 14.1.1 7.2.1 Version Number(s) {#version-numbers-2}

Certificate Revocation Lists are of type X.509 v2.

### 14.1.2 7.2.2 CRL and CRL Entry Extensions {#crl-and-crl-entry-extensions-1}
...
#### 14.1.2.1 7.2.2.1 CRL Issuing Distribution Point
...
### 14.2.1 7.3.1 Version Number(s) {#version-numbers-3}

No stipulation

### 14.2.2 7.3.2 OCSP Extensions {#ocsp-extensions-1}

The singleExtensions of an OCSP response does not contain the reasonCode
(OID 2.5.29.21) CRL entry extension..

# 15 8. COMPLIANCE AUDIT AND OTHER ASSESSMENTS

## 15.1 8.1 Frequency and Circumstances of Assessment

Audits on the certification service operated and managed by NAVER Cloud
Trust Services are conducted at least annually.

## 15.2 8.2 Identity/Qualifications of Assessor
...
## 15.3 8.3 Assessor's Relationship to Assessed Entity
...
## 15.4 8.4 Topics Covered by Assessment
...
## 15.5 8.5 Actions Taken as a Result of Deficiency
...
## 15.6 8.6 Communications of Results
...
### 16.1.4 9.1.4 Fees for Other Services

NAVER Cloud Trust Services does not charge an additional fee for
accessing or viewing this CP/CPS.

### 16.1.5 9.1.5 Refund Policy

NAVER Cloud Trust Services establishes refund policies depending on
certificate types at a general and reasonable level.

## 16.2 9.2 Financial Responsibility

### 16.2.1 9.2.1 Insurance Coverage

NAVER Cloud maintains general liability insurance coverage.

### 16.2.2 9.2.2 Other Assets

No stipulation.

### 16.2.3 9.2.3 Insurance or Warranty Coverage for End-Entities

No stipulation.

## 16.3 9.3 Confidentiality of Business Information

### 16.3.1 9.3.1 Scope of Confidential Information
...
### 16.3.2 9.3.2 Information Not Within the Scope of Confidential Information
...
### 16.3.3 9.3.3 Responsibility to Protect Confidential Information
...
## 16.4 9.4 Privacy of Personal Information

### 16.4.1 9.4.1 Privacy Plan
...
### 16.4.2 9.4.2 Information Treated as Private

See Section 9.4.1

### 16.4.3 9.4.3 Information Not Deemed Private

See Section 9.4.1

### 16.4.4 9.4.4 Responsibility to Protect Private Information

See Section 9.4.1

### 16.4.5 9.4.5 Notice and Consent to Use Private Information

See Section 9.4.1

### 16.4.6 9.4.6 Disclosure Pursuant to Judicial or Administrative Process

See Section 9.4.1

### 16.4.7 9.4.7 Other Information Disclosure Circumstances

See Section 9.4.1

## 16.5 9.5 Intellectual Property rights
...
### 16.5.1 9.5.1 Property Rights in Certificates and Revocation Information
...
### 16.5.2 9.5.2 Property Rights in the Agreement
...
### 16.5.3 9.5.3 Property Rights of Names
...
### 16.5.4 9.5.4 Property Rights in Key Pairs

Private Keys and Public Keys remain the property of the Subscribers who
rightfully hold them.

## 16.6 9.6 Representations and Warranties

### 16.6.1 9.6.1 CA Representations and Warranties
...
### 16.6.2 9.6.2 RA Representations and Warranties

> No stipulation

### 16.6.3 9.6.3 Subscriber Representations and Warranties
...
### 16.6.4 9.6.4 Relying Party Representations and Warranties
...
### 16.6.5 9.6.5 Representations and Warranties of Other Participants

No stipulation.

## 16.7 9.7 Disclaimers of Warranties
...
## 16.8 9.8 Limitations of Liability
...
## 16.9 9.9 Indemnities

### 16.9.1 9.9.1 By Subscriber
...
### 16.9.2 9.9.2 By Relying Parties
...
## 16.10 9.10 Term and Termination
...
### 16.10.2 9.10.2 Termination

This CP/CPS and the related policy documents remain in effect until
replaced by a newer version.

### 16.10.3 9.10.3 Effect of Termination and Survival
...
## 16.11 9.11 Individual Notices and Communications with Participants

All the participants, including the relying parties, may communicate
with each other in a reasonable manner if necessary.

## 16.12 9.12 Amendments

### 16.12.1 9.12.1 Procedure for Amendment
...
### 16.12.2 9.12.2 Notification Mechanism and Period
...
### 16.12.3 9.12.3 Circumstances Under Which OID Must be Changed
...
## 16.13 9.13 Dispute Resolution Provisions
...
## 16.15 9.15 Compliance with Applicable Law

This CP/CPS is subject to all applicable laws and regulations.

## 16.16 9.16 Miscellaneous Provisions

### 16.16.1 9.16.1 Entire Agreement

No stipulation.

### 16.16.2 9.16.2 Assignment
...
### 16.16.4 9.16.4 Enforcement (Attorneys' Fees and Waiver of Rights)
...
## 16.17 9.17 Other Provisions

No stipulation.

# 17 APPENDIX A: CHANGE HISTORY
